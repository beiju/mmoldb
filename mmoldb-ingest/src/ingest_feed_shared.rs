...
pub(crate) const FEED_INVERSION_EVENT_START: DateTime<Utc> =
    datetime_from_parts(2026, 03, 29, 06, 32, 29, 494640);
pub(crate) const FEED_INVERSION_EVENT_END: DateTime<Utc> =
    datetime_from_parts(2026, 03, 29, 09, 15, 58, 247522);
