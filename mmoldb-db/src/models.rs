...
pub struct DbGame {
    ...
    pub away_manager_name: Option<String>,
    pub home_team_emoji: String,
    pub home_team_name: String,
    pub home_team_mmolb_id: String,
    pub home_manager_name: Option<String>,
    pub is_ongoing: bool,
...
pub struct NewPlayerVersion<'a> {
    ...
    pub lesser_durability: Option<i32>,
    pub greater_durability: Option<i32>,
    pub priority: Option<f64>,
    pub xp: Option<i32>,
    pub name_suffix: Option<&'a str>,
    pub level: Option<i32>,
    pub planned_level: Option<i32>,
    pub play_level: Option<i32>,
    pub friends: Vec<&'a str>,
