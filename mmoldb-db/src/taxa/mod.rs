...
impl From<mmolb_parsing::enums::Attribute> for TaxaAttribute {
    fn from(value: mmolb_parsing::enums::Attribute) -> Self {
        match value {
            ...
            mmolb_parsing::enums::Attribute::Deception => Self::Deception,
            mmolb_parsing::enums::Attribute::Intuition => Self::Intuition,
        }
    }
}
...
impl Into<mmolb_parsing::enums::Attribute> for TaxaAttribute {
    fn into(self) -> mmolb_parsing::enums::Attribute {
        match self {
            ...
            Self::Deception => mmolb_parsing::enums::Attribute::Deception,
            Self::Intuition => mmolb_parsing::enums::Attribute::Intuition,
        }
    }
}
...
taxa! {
    #[
        schema = crate::taxa_schema::taxa::modification_type,
        table = crate::taxa_schema::taxa::modification_type::dsl::modification_type,
...
taxa! {
    #[
        schema = crate::taxa_schema::taxa::pollen_count,
        table = crate::taxa_schema::taxa::pollen_count::dsl::pollen_count,
        id_column = crate::taxa_schema::taxa::pollen_count::dsl::id,
        derive = (Serialize)
    ]
    pub enum TaxaPollenCount {
        #[display_name: &'a str = "LOW"]
        Low = 0,
        #[display_name: &'a str = "MEDIUM"]
        Medium = 1,
        #[display_name: &'a str = "HIGH"]
        High = 2,
        #[display_name: &'a str = "EXTREME"]
        Extreme = 3,
    }
}

impl From<mmolb_parsing::enums::PollenCount> for TaxaPollenCount {
    fn from(value: mmolb_parsing::enums::PollenCount) -> Self {
        match value {
            mmolb_parsing::enums::PollenCount::Low => TaxaPollenCount::Low,
            mmolb_parsing::enums::PollenCount::Medium => TaxaPollenCount::Medium,
            mmolb_parsing::enums::PollenCount::High => TaxaPollenCount::High,
            mmolb_parsing::enums::PollenCount::Extreme => TaxaPollenCount::Extreme,
        }
    }
}
...
taxa! {
    #[
        schema = crate::taxa_schema::taxa::season_status,
        table = crate::taxa_schema::taxa::season_status::dsl::season_status,
        id_column = crate::taxa_schema::taxa::season_status::dsl::id,
        derive = (Serialize)
    ]
    pub enum TaxaSeasonStatus {
        #[display_name: &'a str = "Election"]
        Election = 1,
        #[display_name: &'a str = "Holiday"]
        Holiday = 2,
        ...
        #[display_name: &'a str = "Preseason"]
        Preseason = 8,
        #[display_name: &'a str = "Regular Season"]
        RegularSeason = 9,
        #[display_name: &'a str = "Superstar Break"]
        SuperstarBreak = 10,
        #[display_name: &'a str = "Event"]
        Event = 11,
        #[display_name: &'a str = "Superstar Day 1"]
        SuperstarDay1 = 12,
    }
}

impl TryFrom<mmolb_parsing::enums::SeasonStatus> for TaxaSeasonStatus {
    type Error = mmolb_parsing::enums::SeasonStatus;

    fn try_from(value: mmolb_parsing::enums::SeasonStatus) -> Result<Self, Self::Error> {
        Ok(match value {
            ...
            mmolb_parsing::enums::SeasonStatus::SuperstarDay1 => TaxaSeasonStatus::SuperstarDay1,
            other => Err(other)?,
        })
    }
}
...
pub struct Taxa {
    ...
    pollen_count_mapping: EnumMap<TaxaPollenCount, i64>,
    season_status_mapping: EnumMap<TaxaSeasonStatus, i64>,
}
...
impl Taxa {
    pub fn new(conn: &mut PgConnection) -> QueryResult<Self> {
        Ok(Self {
            ...
            pollen_count_mapping: TaxaPollenCount::make_id_mapping(conn)?,
            season_status_mapping: TaxaSeasonStatus::make_id_mapping(conn)?,
        })
    }
    ...
    pub fn pollen_count_id(&self, ty: TaxaPollenCount) -> i64 {
        self.pollen_count_mapping[ty]
    }

    pub fn season_status_id(&self, ty: TaxaSeasonStatus) -> i64 {
        self.season_status_mapping[ty]
    }
    ...
    pub fn modification_type_from_id(&self, id: i64) -> TaxaModificationType {
        self.modification_type_mapping
            .iter()
            .find(|(_, ty_id)| id == **ty_id)
            .expect("TODO Handle unknown modification type")
            .0
    }

    pub fn pollen_count_from_id(&self, id: i64) -> TaxaPollenCount {
        self.pollen_count_mapping
            .iter()
            .find(|(_, ty_id)| id == **ty_id)
            .expect("TODO Handle unknown pollen count")
            .0
    }

    pub fn season_status_from_id(&self, id: i64) -> TaxaSeasonStatus {
        self.season_status_mapping
            .iter()
            .find(|(_, ty_id)| id == **ty_id)
            .expect("TODO Handle unknown season status")
            .0
    }
}
