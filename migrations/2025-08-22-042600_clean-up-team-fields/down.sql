...
alter table data.team_versions
    add column ballpark_use_city boolean,
    add column ballpark_suffix text,
    add column ballpark_word_2 text,
    add column ballpark_word_1 text,
    add column motes_used integer,
    add column eligible text;
