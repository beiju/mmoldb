-- Drop events_extended, because it references cheer tables
...
alter table data.events
    add column cheer text; -- null = no cheer (common case)

-- Re-create events_extended view with the old cheer handling
-- (also remove manager names, for accurate reversion)
